...
class GameUI:
    def __init__(self):
        ...
        self.default_health_full = pygame.image.load('ui/default_health/default_full_health_ui.png').convert_alpha()
        self.default_health_5 = pygame.image.load('ui/default_health/default_5_health_ui.png').convert_alpha()
        self.default_health_4 = pygame.image.load('ui/default_health/default_4_health_ui.png').convert_alpha()
        self.default_health_3 = pygame.image.load('ui/default_health/default_3_health_ui.png').convert_alpha()
        self.default_health_2 = pygame.image.load('ui/default_health/default_2_health_ui.png').convert_alpha()
        self.default_health_1 = pygame.image.load('ui/default_health/default_1_health_ui.png').convert_alpha()
        self.default_health_0 = pygame.image.load('ui/default_health/default_0_health_ui.png').convert_alpha()
        ...
        self.default_ui = pygame.image.load('ui/default_state_ui.png').convert_alpha()
